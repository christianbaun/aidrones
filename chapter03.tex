...
\renewcommand{\deutschertitel}{Schutz der Komponenten beim ersten Anschluss des Akkus mit einem Smoke Stopper}
\renewcommand{\englischertitel}{Protection of the Components during the first Battery Connection using a Smoke Stopper}
\makroabschnitt
