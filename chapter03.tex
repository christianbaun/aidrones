...
\begin{itemize}
\item \textsl{Minimum version of Backpack version 1.5} - If this requirement is not met, refer to Section~\ref{AbbildungExpressLRSTXBackpack1} for instructions on updating the Backpack firmware.
\end{itemize}
