...
iNAV stellt einen eigenen Follow-Me-Modus bereit, der die GPS-Position eines externen Geräts verwendet, üblicherweise die Fernsteuerung mit einem angeschlossenen GPS-Modul oder einem kompatiblen Telemetriesystem. 
...
Die Follow-Me-Funktion in iNAV erfordert einen Flight Controller mit GPS, Barometer, Magnetkompass sowie einen stabilen GPS-Empfang. Das externe Gerät überträgt seine Position über ein Telemetrieprotokoll wie MAVLink, MSP oder ein proprietäres Senderprotokoll an den Flight Controller.
