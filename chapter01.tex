...
\item \textsl{INAV}: Compared to Betaflight, INAV is more navigation-oriented and supports a wider range of positioning sensors. However, compatibility is still largely limited to selected peripherals, primarily MSP-based devices such as the MicoAir MTF-01 or the Matek 3901-L0X.
...
\begin{figure}[htbp]
  ...
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includegraphics[width=\linewidth]{MicoAir_Optical_Flow_Lidar_Sensor_MTF_01P.png}
    \vspace{0pt} % sorgt für Top-Ausrichtung
  \end{minipage}\hfill
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includegraphics[width=\linewidth]{Matek_3901_L0X_Optical_Flow_and_Lidar.png}
    \vspace{0pt}
  \end{minipage}
  \caption{MicoAir MTF-01P and Matek 3901-L0X Optical Flow and Lidar Sensor}
  \label{MicoAirAndMatekOFSensor}
\end{figure}
\FloatBarrier
