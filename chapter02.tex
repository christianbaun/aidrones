...
\begin{itemize}
\item \textsl{Log Generation} - Configuring the firmware to capture sensor data during test flights and extract the data.
\end{itemize}

\colger

\begin{itemize}
\item \textsl{Log Generation} - TBD
\end{itemize}
...
\renewcommand{\deutschertitel}{Fluglogbasierte Vibrationsreduktion}
\renewcommand{\englischertitel}{Flight Log–Based Vibration Reduction}
\makrounterabschnitt
